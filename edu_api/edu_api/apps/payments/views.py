...
class AliPayAPIView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            return Response({"message": "当前订单不存在！警告！"}, status=status.HTTP_400_BAD_REQUEST)
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url=settings.ALIAPY_CONFIG["return_url"],  # 同步回调地址
...
class AliPayResultAPIView(APIView):
    ...
    def get(self, request):
        ...
        return Response({"message": "当前订单支付失败！请重新支付！"})
    ...
    def order_result_pay(self, data):
        ...
        try:
            ...
            return Response({"message": "对不起，支付结果查询失败！该订单或许不存在！"}, status=status.HTTP_400_BAD_REQUEST)
        #开启事务
        with transaction.atomic():
            ...
            try:
                ...
                for order_detail in order_detail_list:
                    ...
                    # 用户购买的课程是否长期有效  如果不是长期有效则为课程记录到期时间
