    ...
    <div class="login box">
        ...
        <div class="login">
            ...
            <div class="login_box">
                ...
                <div class="inp" v-if="loginType==='pwd'">
                ...
                <div class="inp" v-else>
                    ...
                    <button id="get_code" class="btn btn-primary" @click="get_msg">{{msg_text}}</button>
                    <button class="login_btn" @click="user_msg_login">登录</button>
...
<script>
    export default {
        ...
        methods: {
            ...
            user_msg_login() {
                this.$axios({
                    url: this.$settings.HOST + "user/msg_login/",
                    method: "post",
                    data: {
                        mobile: this.mobile,
                        code: this.code,
